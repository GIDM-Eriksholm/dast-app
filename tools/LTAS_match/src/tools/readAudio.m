...
%   fsRefHz : requested sampling frequency in Hertz, the audio signal will
%             be resampled accordingly (default, fsRefHz = []) 
%     range : select sample range for all channels, either range = N to
%             extract the first N samples or range = [N1 N2] to extract a
%             specific sample range (default, range = []) 
% 
