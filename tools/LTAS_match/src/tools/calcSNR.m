...
%   To avoid that the SNR is biased, the DC component of both signals is
%   removed prior to calculating the SNR.  
% 
%USAGE
...
%               default, the correlation coefficient is calculated across
%               the first non-singleton dimension of the target signal 
